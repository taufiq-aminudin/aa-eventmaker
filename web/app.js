...
function createProject(){
  ...
  const project={id:crypto.randomUUID?crypto.randomUUID():Date.now().toString(),name,type,date,createdAt:new Date().toISOString()};
  localStorage.setItem("aaem_project",JSON.stringify(project));
  document.getElementById("projectResult").textContent=`✓ Project “${name}” created. Next: add your invitation, photos, guests and venue.`;
