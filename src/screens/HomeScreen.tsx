...
export const HomeScreen: React.FC<HomeScreenProps> = ({
  ...
  return (
    <div id="home-screen" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 space-y-6">
      ...
      {/* Veo 3 Video from Text Feature Banner */}
      <div className="bg-gradient-to-r from-purple-900 via-indigo-900 to-slate-900 rounded-2xl p-5 sm:p-6 text-white shadow-sm flex flex-col md:flex-row items-start md:items-center justify-between gap-4 border border-indigo-800/40">
        <div className="flex items-start space-x-3.5">
          <div className="w-11 h-11 rounded-xl bg-purple-500/20 border border-purple-400/30 flex items-center justify-center shrink-0 text-amber-300 shadow-inner">
            <Film className="w-5 h-5 text-amber-300" />
          </div>
          <div>
            <div className="flex items-center space-x-2">
              <span className="text-[10px] font-extrabold uppercase tracking-wider bg-purple-500/30 text-purple-200 px-2 py-0.5 rounded-full border border-purple-400/30">
                Fitur AI Baru
              </span>
            ...
            <h3 className="text-base font-bold text-white mt-1">
              Generate video from text dengan Veo 3
            </h3>
            <p className="text-xs text-slate-300 mt-0.5 max-w-xl">
              Ciptakan video teaser sinematik pesta pernikahan atau acara spesial langsung dari deskripsi teks (16:9 Landscape atau 9:16 Portrait) dan sematkan langsung ke undangan Anda.
            </p>
          </div>
        </div>
        ...
        <button
          ...
          className="px-4 py-2.5 bg-gradient-to-r from-purple-500 to-indigo-500 hover:from-purple-600 hover:to-indigo-600 text-white font-bold text-xs rounded-xl shadow-xs transition-all flex items-center space-x-2 shrink-0 self-stretch sm:self-auto justify-center cursor-pointer"
        >
          <Sparkles className="w-3.5 h-3.5 text-amber-300" />
          <span>Coba Video Generator</span>
          <ArrowRight className="w-3.5 h-3.5" />
        </button>
      </div>
