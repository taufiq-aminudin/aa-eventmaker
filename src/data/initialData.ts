...
export const TEMPLATES_DATA: TemplateItem[] = [
  {
    ...
    videoAspect: '16:9',
    animationStyle: 'Luxury Shimmer & Golden Sparks',
  },
  {
    id: 'tmpl_jawa',
    ...
    videoAspect: '9:16',
    animationStyle: 'Gunungan Wayang Reveal & Gamelan Soundscape',
  },
  {
    id: 'tmpl_sunda',
    title: 'Sunda Halus',
    ...
    videoAspect: '9:16',
    animationStyle: 'Siger Glow & Suling Sunda Ambience',
  },
  {
    id: 'tmpl_bali',
    title: 'Bali Ayu',
    ...
    videoAspect: '16:9',
    animationStyle: 'Candi Bentar Gate Opening & Rindik Atmosphere',
  },
  {
    id: 'tmpl_garden',
    title: 'Garden Bloom',
    ...
    previewVideoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4',
    videoAspect: '16:9',
    animationStyle: 'Petal Falling Breeze',
  },
  {
    id: 'tmpl_ballroom',
    ...
    videoAspect: '16:9',
    animationStyle: 'Chandelier Crystal Glow & Orchestral Strings',
  },
  {
    id: 'tmpl_engagement',
    ...
    previewVideoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerEscapes.mp4',
    videoAspect: '9:16',
    animationStyle: 'Pastel Confetti & Ring Shimmer',
  },
  {
    id: 'tmpl_birthday',
    title: 'Birthday Pop',
    ...
    previewVideoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4',
    videoAspect: '9:16',
    animationStyle: 'Colorful Confetti & Neon Flash',
  },
  {
    id: 'tmpl_corporate',
    ...
    previewVideoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/TearsOfSteel.mp4',
    videoAspect: '16:9',
    animationStyle: 'Executive Hologram & Sleek Cyber Lines',
  },
  {
    id: 'tmpl_baby',
    ...
    previewVideoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4',
    videoAspect: '9:16',
    animationStyle: 'Floating Clouds & Twinkling Stars',
  },
  {
    id: 'tmpl_jogja_solo',
    ...
    previewVideoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/WeAreGoingOnBullrun.mp4',
    videoAspect: '16:9',
    animationStyle: 'Royal Golden Mist & Keraton Gamelan',
  },
  {
    ...
    previewVideoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerEscapes.mp4',
    videoAspect: '9:16',
    animationStyle: 'Smooth Monochrome Fade & Editorial Tracking',
  },
  {
    ...
    previewVideoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4',
    videoAspect: '16:9',
    animationStyle: 'Golden Arabesque Shimmer & Soft Tilawah Tone',
  },
  {
    ...
    previewVideoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/TearsOfSteel.mp4',
    videoAspect: '16:9',
    animationStyle: 'Silver Sparkles & Classical Waltz',
  },
  {
    id: 'tmpl_graduation',
    ...
    previewVideoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4',
    videoAspect: '16:9',
    animationStyle: 'Gold Toga Confetti Burst',
  },
  {
    ...
    previewVideoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4',
    videoAspect: '9:16',
    animationStyle: 'Playful Safari Animals & Balloon Pop',
    isPopular: true,
  },
  {
    id: 'tmpl_minang_royal',
    title: 'Minangkabau Rumah Gadang',
    category: 'Adat Heritage',
    eventTypeId: 'wedding',
    culturalStyle: 'Minangkabau',
    styleTag: 'Songket Marawa',
    colorName: 'Merah & Emas Marawa',
    gradientTheme: 'bg-gradient-to-br from-[#7f1d1d] via-[#991b1b] to-[#eab308]',
    gradientColors: ['#7f1d1d', '#991b1b', '#eab308'],
    description: 'Kemegahan ornamen gonjong Rumah Gadang, kain tenun songket Pandai Sikek berbenang emas, dan warna kebesaran Marawa Minangkabau.',
    svgAsset: '/assets/templates/elegant-white.svg',
    sampleHosts: 'Muhammad Fadly Sutan Pangeran & Putri Nilam Sari',
    sampleDate: 'Sabtu, 19 Desember 2026',
    sampleVenue: 'Balai Samudera Heritage Hall, Kelapa Gading',
    sampleOpening: 'Barek samo dipikua, ringan samo dijinjiang. Basamo mambina tali pusako dalam ikatan janji suci panikahan.',
    sampleQuote: 'Adat basandi syarak, syarak basandi Kitabullah.',
    defaultCoverPhoto: 'https://images.unsplash.com/photo-1544816155-12df9643f363?auto=format&fit=crop&w=1200&q=80',
    defaultCouplePhoto: 'https://images.unsplash.com/photo-1606800052052-a08af7148866?auto=format&fit=crop&w=800&q=80',
    accentColor: '#eab308',
    ...
    previewVideoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4',
    videoAspect: '16:9',
    animationStyle: 'Marawa Gold Reveal & Saluang Melodies',
    isPopular: true,
    isNewest: true,
  },
  {
    id: 'tmpl_batak_ulos',
    title: 'Batak Ulos & Gorga Heritage',
    category: 'Adat Heritage',
    eventTypeId: 'wedding',
    culturalStyle: 'Batak',
    styleTag: 'Ulos Ni Tondi',
    colorName: 'Crimson & Tenun Ulos',
    gradientTheme: 'bg-gradient-to-br from-[#450a0a] via-[#1c1917] to-[#b91c1c]',
    gradientColors: ['#450a0a', '#1c1917', '#b91c1c'],
    description: 'Kehangatan Ulos Ragi Hotang, ukiran motif Gorga Batak Toba yang berwibawa, dan iringan gondang sabangunan.',
    svgAsset: '/assets/templates/ballroom-classic.svg',
    sampleHosts: 'Togar Marbun, S.T. & Melisa Boru Simanjuntak, S.E.',
    sampleDate: 'Sabtu, 07 November 2026',
    sampleVenue: 'Gedung Mulia & Raja Convention Hall, Jakarta Timur',
    sampleOpening: 'Horas! Dibagasan asi dohot holong ni roha ni Tuhanta, manjalo pasu-pasu parbagason na badia.',
    sampleQuote: 'Hot do jabu i, hotan margorga-gorga; Mauliate ma di Tuhanta, sai ro ma las ni roha.',
    defaultCoverPhoto: 'https://images.unsplash.com/photo-1519741497674-611481863552?auto=format&fit=crop&w=1200&q=80',
    defaultCouplePhoto: 'https://images.unsplash.com/photo-1583939003579-730e3918a45a?auto=format&fit=crop&w=800&q=80',
    accentColor: '#b91c1c',
    patternType: 'traditional',
    requiredTier: 'professional',
    ...
    previewVideoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/WeAreGoingOnBullrun.mp4',
    videoAspect: '16:9',
    animationStyle: 'Gorga Carving Fade & Gondang Harmony',
    isPopular: false,
    isNewest: true,
  },
  {
    id: 'tmpl_khitanan_berkah',
    title: 'Tasyakuran Khitanan Berkah',
    category: 'Circumcision',
    eventTypeId: 'khitanan',
    culturalStyle: 'Islamic',
    styleTag: 'Walimatul Khitan',
    colorName: 'Hijau Zamrud & Emas',
    gradientTheme: 'bg-gradient-to-br from-[#064e3b] via-[#047857] to-[#eab308]',
    gradientColors: ['#064e3b', '#047857', '#eab308'],
    description: 'Desain syukuran khitanan islami yang elegan dengan doa keberkahan, kaligrafi suci, dan ornamen perayaan ceria.',
    svgAsset: '/assets/templates/elegant-white.svg',
    sampleHosts: 'Walimatul Khitan: Ahmad Danish Al-Ghifari',
    sampleDate: 'Ahad, 29 November 2026',
    sampleVenue: 'Masjid Agung Al-Barkah Ballroom, Bekasi',
    sampleOpening: 'Bismillahir Rahmanir Rahim. Puji syukur ke hadirat Allah SWT, kami bermaksud menyelenggarakan syukuran khitanan putra kami.',
    sampleQuote: 'Semoga ananda menjadi anak yang sholeh, cerdas, berbakti kepada orang tua, dan berguna bagi nusa bangsa.',
    defaultCoverPhoto: 'https://images.unsplash.com/photo-1519689680058-324335c77eba?auto=format&fit=crop&w=1200&q=80',
    defaultCouplePhoto: 'https://images.unsplash.com/photo-1555252333-9f8e92e65df9?auto=format&fit=crop&w=800&q=80',
    accentColor: '#eab308',
    patternType: 'islamic',
  ...
  {
    id: 'tmpl_housewarming_barakah',
    title: 'Tasyakuran Rumah Baru & Silaturahmi',
    category: 'House & Family',
    eventTypeId: 'housewarming',
    culturalStyle: 'Modern',
    styleTag: 'Warm Home Sanctuary',
    colorName: 'Hijau Botani & Warm Sand',
    gradientTheme: 'bg-gradient-to-br from-[#14532d] via-[#166534] to-[#ca8a04]',
    gradientColors: ['#14532d', '#166534', '#ca8a04'],
    description: 'Nuansa hangat syukuran menempati kediaman baru bersama tetangga, kerabat, dan doa selamat Baitii Jannatii.',
    svgAsset: '/assets/templates/garden-romance.svg',
    sampleHosts: 'Keluarga Bpk. Hendra Pratama & Ibu Rini',
    sampleDate: 'Sabtu, 10 Oktober 2026',
    sampleVenue: 'Cluster Bukit Golf Mediterania No. 8, BSD City',
    sampleOpening: 'Assalamu’alaikum Wr. Wb. Dengan penuh rasa syukur, kami mengundang Bapak/Ibu untuk menghadiri tasyakuran menempati rumah baru kami.',
    sampleQuote: 'Rumahku Surgaku. Semoga hunian ini senantiasa dipenuhi keberkahan, ketenangan, dan cinta.',
    defaultCoverPhoto: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=1200&q=80',
    defaultCouplePhoto: 'https://images.unsplash.com/photo-1519741497674-611481863552?auto=format&fit=crop&w=800&q=80',
    accentColor: '#16a34a',
    patternType: 'floral',
    requiredTier: 'starter',
    ...
    previewVideoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerEscapes.mp4',
    videoAspect: '9:16',
    animationStyle: 'Warm Hearth Shimmer',
    isPopular: false,
    isNewest: true,
  },
  {
    id: 'tmpl_tahlilan_khidmat',
    title: 'Tahlilan & Doa Bersama Khidmat',
    category: 'Memorial',
    eventTypeId: 'tahlilan',
    culturalStyle: 'Islamic',
    styleTag: 'Doa Khidmat',
    colorName: 'Slate & White Purity',
    gradientTheme: 'bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#475569]',
    gradientColors: ['#0f172a', '#1e293b', '#475569'],
    description: 'Format doa peringatan khidmat, bacaan Yasin dan tahlil dengan tipografi tenang, kaligrafi doa, dan penghormatan tulus.',
    svgAsset: '/assets/templates/ballroom-classic.svg',
    sampleHosts: 'Keluarga Besar Alm. H. Bambang Soetopo',
    sampleDate: 'Jumat, 13 November 2026',
    sampleVenue: 'Kediaman Keluarga, Jl. Wijaya Kusuma No. 12, Jakarta',
    sampleOpening: 'Inna lillahi wa inna ilaihi raji’un. Mengenang 40 hari berpulangnya almarhum, kami memohon kehadiran Bapak/Ibu untuk melantunkan tahlil dan doa bersama.',
    sampleQuote: 'Ya Allah, tempatkanlah beliau di sisi-Mu dalam surga-Mu yang abadi.',
    defaultCoverPhoto: 'https://images.unsplash.com/photo-1519689680058-324335c77eba?auto=format&fit=crop&w=1200&q=80',
    defaultCouplePhoto: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=800&q=80',
    accentColor: '#94a3b8',
    patternType: 'modern',
